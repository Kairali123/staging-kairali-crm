...
| Batch cap | 10 items, then checkpoint |
...
| Daily reporting | Publish each error to Git immediately after sanitization; publish one GitHub daily roll-up before sign-off and notify the governance owner |
