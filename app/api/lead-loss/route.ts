...
const COMPANY_CONFIG: CompanyConfig[] = [
  {
    ...
    sources: [
      ...
      },
      {
        ...
        mobileCol: "mobile",
        leadIdCol: "id",
        sourceFilter: "website_name LIKE '%villa%' OR website_name LIKE '%raag%'",
      },
      {
        source: "Exit Popup",
        table: "site_exit_popup_lead_generation_api",
        dateCol: "Created_date_time",
        mobileCol: "phone",
        leadIdCol: "id",
        sourceFilter: "landing_page LIKE '%villa%' OR landing_page LIKE '%raag%'",
      },
    ],
  },
  {
    ...
    sources: [
      ...
      },
      {
        ...
        mobileCol: "mobile",
        leadIdCol: "id",
        sourceFilter: "website_name LIKE '%KTAHV%' OR website_name LIKE '%healing village%'",
      },
      {
        source: "Exit Popup",
        table: "site_exit_popup_lead_generation_api",
        ...
        mobileCol: "phone",
        leadIdCol: "id",
        sourceFilter: "landing_page LIKE '%ktahv%' OR landing_page LIKE '%healing village%'",
      },
    ],
  },
  {
    company: "Kairali",
    companyKey: "KAIRALI",
    bufferMatch: ["kairali ayurvedic group", "kag"],
    sources: [
      {
        source: "Priya AI Web",
        table: "kairali_chatbase_leads_api_priya_sharma",
        dateCol: "chat_created_date_time",
        mobileCol: "phone",
        leadIdCol: "lead_id",
      },
      {
        ...
        mobileCol: "phone",
        leadIdCol: "id",
        sourceFilter: "landing_page NOT LIKE '%villa%' AND landing_page NOT LIKE '%raag%' AND landing_page NOT LIKE '%ktahv%' AND landing_page NOT LIKE '%healing village%'",
      },
      {
        source: "Others",
        table: "bulk_whatsapp_reply_enquiry_generation",
        ...
        mobileCol: "mobile",
        leadIdCol: "id",
        sourceFilter: "website_name NOT LIKE '%villa%' AND website_name NOT LIKE '%raag%' AND website_name NOT LIKE '%ktahv%' AND website_name NOT LIKE '%healing village%'",
      },
    ]
  }
];
