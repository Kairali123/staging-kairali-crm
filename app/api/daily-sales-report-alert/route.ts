...
import { combineSales, companies, type SaleDetail, type CollectionDetail } from '@/lib/daily-sales-report'
...
export async function GET(req:NextRequest){
 ...
 try{
  ...
  try {
    ...
    console.error('[daily-sales-report-alert] rawCollections error:', e)
  }
  ...
  function resolveCollectionCompany(comp: string): string {
