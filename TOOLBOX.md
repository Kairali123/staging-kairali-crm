...
| Local repository + Edge browser | WA-001 WhatsApp trigger page and Redlava integration | Inspect/edit/test scoped application code; inspect Redlava templates/API docs; create requested report templates | No recipient sends without specified test recipient; credential/environment writes remain gated | Diff, validation, provider approval readback |
